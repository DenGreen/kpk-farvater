...
import imgLogo from '../../img/footer-logo.svg';
...
const Footer = () => {
  return (
    <footer className="footer">
      <section className="footer__box width-adaptiv">
        <div className="footer__inner">
          <img
            className="footer__img"
            src={imgLogo}
            alt="Логотип компании Фарватер"
          />
              ...
              {navArrNew.map((value, id) => {
                ...
                return (
                  <li className="footer__item" key={id}>
                    <NavLink className="footer__link" to={value.path}>
                      {value.breadcrumb}
                    </NavLink>
                  </li>
                );
        ...
        <div className="footer__desc">
          <div className="footer__desc-box">
            <span className="footer__copyright">© 2021, КПК «Фарватер»</span>
            <a
            ...
            <NavLink className="footer__copyright-holder" to="/">
          ...
          <div className="footer__contact-box">
            ...
            <div className="footer__info-message">
              <a
                className="footer__viber"
              ...
              <a className="footer__whatsapp" href="https://wa.me/+70000000000">
                <svg
                  width="36"
                  height="36"
                  viewBox="0 0 36 36"
            ...
            <a className="footer__email" href="mailto:test@gmail.com">
              test@gmail.com
            </a>
            <span className="footer__info-desc">
